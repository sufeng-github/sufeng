<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="状态">
              <j-dict-select-tag placeholder="请选择状态" v-model="queryParam.status" dictCode="purchaseStatus"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8" >
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('csm_purchase')">导出</a-button>
    ...
    <csmPurchase-modal ref="modalForm" @ok="modalFormOk"></csmPurchase-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/purchase/csmPurchase/list",
          delete: "/purchase/csmPurchase/delete",
          deleteBatch: "/purchase/csmPurchase/deleteBatch",
          exportXlsUrl: "/purchase/csmPurchase/exportXls",
          importExcelUrl: "purchase/csmPurchase/importExcel",
        },
        dictOptions:{
         status:[],
        }
