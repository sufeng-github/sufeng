          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="工具箱">
                <a-input placeholder="请输入工具箱" v-model="queryParam.tooId"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
  ...
  export default {
          ...
          },
          {
            ...
            customRender:(text)=>{
              if(!text){
                ...
                return filterMultiDictText(this.dictOptions['tooId'], text+"")
              }
            }
          },
          {
    ...
    methods: {
      initDictConfig(){
        ...
        initDictOptions('').then((res) => {
          if (res.success) {
            this.$set(this.dictOptions, 'tooId', res.result)
          }
        })
        initDictOptions('').then((res) => {
          if (res.success) {
