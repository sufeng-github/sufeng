          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="12" :sm="16">
              <a-form-item label="工具箱">
                <a-input placeholder="请输入最小值" class="query-group-cust" v-model="queryParam.toolId_begin"></a-input>
                <span class="query-group-split-cust"></span>
                <a-input placeholder="请输入最大值" class="query-group-cust" v-model="queryParam.toolId_end"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
            ...
            <a-col :md="6" :sm="8">
              ...
              <!--  <a-input placeholder="请输入销售公司" v-model="queryParam.companyId"></a-input>-->
                <m-dict-select-tag placeholder="请输入销售公司" v-model="queryParam.companyId" dictCode="saleCompany"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
...
<script>
  ...
  import CsmOrderInfoModal from './modules/CsmOrderInfoModal1'
  ...
  export default {
          ...
          },
          {
            ...
            customRender:(text)=>{
              if(!text){
                ...
                return filterMultiDictText(this.dictOptions['bednum'], text+"")
              }
            }
          },
          {
    ...
    methods: {
      initDictConfig(){
        ...
        initDictOptions('').then((res) => {
          if (res.success) {
            this.$set(this.dictOptions, 'bednum', res.result)
          }
        })
        initDictOptionsmy('saleCompany').then((res) => {
          if (res.success) {
