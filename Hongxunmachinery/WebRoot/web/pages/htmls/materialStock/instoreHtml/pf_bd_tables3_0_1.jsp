	...
	<script>
        $(function(){				
          	//$('#tt').datagrid({data:getData('#tt','${pageContext.request.contextPath}/purchaseItemInStock.htm/loadData')}).datagrid('clientPaging');                 
       		...
       		$.ajax({  
				type: "post",  		
				url: '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/loadData',
...
/* 		function isOnlyRead(){
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/scanOutMaterialNum',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
		...
		$('#userId').combobox({
			...
			url : '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/autotimp', //请求数据路径				
			editable : true, //可编辑
			...
			onSelect : function(record) {
				...
				$.messager.confirm('Confirm', '是否出库?', function(r) {
					if (r) {
						...
						$.ajax({
							type : "post",
							url : '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/searchMaterialNum',
							data : record,
							traditional : true,
							dataType : "json",
							beforeSend : function() {
	...
	<script>
		...
		function saveRow(target){
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/getEntity',
				traditional: true,
				dataType:"json", 
				...
				success: function(result) {		
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/materialNoLimitOutStock.htm/updateRow',
