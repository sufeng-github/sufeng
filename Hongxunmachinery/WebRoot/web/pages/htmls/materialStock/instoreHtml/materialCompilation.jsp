...
<!-- 								<td><a href="javascript:;" id="importBtn" class="easyui-linkbutton"  onclick="$('#importExcelDlg').dialog('open').dialog('setTitle','导入表格')">导入</a> </td> -->
	...
	<script>
			...
			$('#tt').datagrid({	
				loadFilter: function(data){										
 					for(var i=0; i<data.rows.length;i++){
						if(data.rows[i].hongXunMaterialCompilation != null){
							data.rows[i].quantity1		=	data.rows[i].hongXunMaterialCompilation.quantity1;
							data.rows[i].inQuantity1	=	data.rows[i].hongXunMaterialCompilation.inQuantity1;
							data.rows[i].outQuantity1	=	data.rows[i].hongXunMaterialCompilation.outQuantity1;
							data.rows[i].checkQuantity1	=	data.rows[i].hongXunMaterialCompilation.checkQuantity1;
							data.rows[i].diffQuantity1	=	data.rows[i].hongXunMaterialCompilation.diffQuantity1;
							data.rows[i].remark1		=	data.rows[i].hongXunMaterialCompilation.remark1;
							data.rows[i].quantity2		=	data.rows[i].hongXunMaterialCompilation.quantity2;
							data.rows[i].inQuantity2	=	data.rows[i].hongXunMaterialCompilation.inQuantity2;
							data.rows[i].outQuantity2	=	data.rows[i].hongXunMaterialCompilation.outQuantity2;
							data.rows[i].checkQuantity2	=	data.rows[i].hongXunMaterialCompilation.checkQuantity2;
							data.rows[i].diffQuantity2	=	data.rows[i].hongXunMaterialCompilation.diffQuantity2;
							data.rows[i].remark2		=	data.rows[i].hongXunMaterialCompilation.remark2;
							data.rows[i].quantity3		=	data.rows[i].hongXunMaterialCompilation.quantity3;
							data.rows[i].inQuantity3	=	data.rows[i].hongXunMaterialCompilation.inQuantity3;
							data.rows[i].outQuantity3	=	data.rows[i].hongXunMaterialCompilation.outQuantity3;
							data.rows[i].checkQuantity3	=	data.rows[i].hongXunMaterialCompilation.checkQuantity3;
							data.rows[i].diffQuantity3	=	data.rows[i].hongXunMaterialCompilation.diffQuantity3;
							data.rows[i].remark3		=	data.rows[i].hongXunMaterialCompilation.remark3;
							data.rows[i].quantity4		=	data.rows[i].hongXunMaterialCompilation.quantity4;
							data.rows[i].inQuantity4	=	data.rows[i].hongXunMaterialCompilation.inQuantity4;
							data.rows[i].outQuantity4	=	data.rows[i].hongXunMaterialCompilation.outQuantity4;
							data.rows[i].checkQuantity4	=	data.rows[i].hongXunMaterialCompilation.checkQuantity4;
							data.rows[i].diffQuantity4	=	data.rows[i].hongXunMaterialCompilation.diffQuantity4;
							data.rows[i].remark4		=	data.rows[i].hongXunMaterialCompilation.remark4;
							data.rows[i].quantity5		=	data.rows[i].hongXunMaterialCompilation.quantity5;
							data.rows[i].inQuantity5	=	data.rows[i].hongXunMaterialCompilation.inQuantity5;
							data.rows[i].outQuantity5	=	data.rows[i].hongXunMaterialCompilation.outQuantity5;
							data.rows[i].checkQuantity5	=	data.rows[i].hongXunMaterialCompilation.checkQuantity5;
							data.rows[i].diffQuantity5	=	data.rows[i].hongXunMaterialCompilation.diffQuantity5;
							data.rows[i].remark5		=	data.rows[i].hongXunMaterialCompilation.remark5;
							data.rows[i].quantity6		=	data.rows[i].hongXunMaterialCompilation.quantity6;
							data.rows[i].inQuantity6	=	data.rows[i].hongXunMaterialCompilation.inQuantity6;
							data.rows[i].outQuantity6	=	data.rows[i].hongXunMaterialCompilation.outQuantity6;
							data.rows[i].checkQuantity6	=	data.rows[i].hongXunMaterialCompilation.checkQuantity6;
							data.rows[i].diffQuantity6	=	data.rows[i].hongXunMaterialCompilation.diffQuantity6;
							data.rows[i].remark6		=	data.rows[i].hongXunMaterialCompilation.remark6;
							data.rows[i].quantity7		=	data.rows[i].hongXunMaterialCompilation.quantity7;
							data.rows[i].inQuantity7	=	data.rows[i].hongXunMaterialCompilation.inQuantity7;
							data.rows[i].outQuantity7	=	data.rows[i].hongXunMaterialCompilation.outQuantity7;
							data.rows[i].checkQuantity7	=	data.rows[i].hongXunMaterialCompilation.checkQuantity7;
							data.rows[i].diffQuantity7	=	data.rows[i].hongXunMaterialCompilation.diffQuantity7;
							data.rows[i].remark7		=	data.rows[i].hongXunMaterialCompilation.remark7;
							data.rows[i].quantity8		=	data.rows[i].hongXunMaterialCompilation.quantity8;
							data.rows[i].inQuantity8	=	data.rows[i].hongXunMaterialCompilation.inQuantity8;
							data.rows[i].outQuantity8	=	data.rows[i].hongXunMaterialCompilation.outQuantity8;
							data.rows[i].checkQuantity8	=	data.rows[i].hongXunMaterialCompilation.checkQuantity8;
							data.rows[i].diffQuantity8	=	data.rows[i].hongXunMaterialCompilation.diffQuantity8;
							data.rows[i].remark8		=	data.rows[i].hongXunMaterialCompilation.remark8;
							data.rows[i].quantity9		=	data.rows[i].hongXunMaterialCompilation.quantity9;
							data.rows[i].inQuantity9	=	data.rows[i].hongXunMaterialCompilation.inQuantity9;
							data.rows[i].outQuantity9	=	data.rows[i].hongXunMaterialCompilation.outQuantity9;
							data.rows[i].checkQuantity9	=	data.rows[i].hongXunMaterialCompilation.checkQuantity9;
							data.rows[i].diffQuantity9	=	data.rows[i].hongXunMaterialCompilation.diffQuantity9;
							data.rows[i].remark9		=	data.rows[i].hongXunMaterialCompilation.remark9;
							data.rows[i].quantity10		=	data.rows[i].hongXunMaterialCompilation.quantity10;
							data.rows[i].inQuantity10	=	data.rows[i].hongXunMaterialCompilation.inQuantity10;
							data.rows[i].outQuantity10	=	data.rows[i].hongXunMaterialCompilation.outQuantity10;
							data.rows[i].checkQuantity10	=	data.rows[i].hongXunMaterialCompilation.checkQuantity10;
							data.rows[i].diffQuantity10	=	data.rows[i].hongXunMaterialCompilation.diffQuantity10;
							data.rows[i].remark10		=	data.rows[i].hongXunMaterialCompilation.remark10;
							data.rows[i].quantity11		=	data.rows[i].hongXunMaterialCompilation.quantity11;
							data.rows[i].inQuantity11	=	data.rows[i].hongXunMaterialCompilation.inQuantity11;
							data.rows[i].outQuantity11	=	data.rows[i].hongXunMaterialCompilation.outQuantity11;
							data.rows[i].checkQuantity11	=	data.rows[i].hongXunMaterialCompilation.checkQuantity11;
							data.rows[i].diffQuantity11	=	data.rows[i].hongXunMaterialCompilation.diffQuantity11;
							data.rows[i].remark11		=	data.rows[i].hongXunMaterialCompilation.remark11;
							data.rows[i].quantity12		=	data.rows[i].hongXunMaterialCompilation.quantity12;
							data.rows[i].inQuantity12	=	data.rows[i].hongXunMaterialCompilation.inQuantity12;
							data.rows[i].outQuantity12	=	data.rows[i].hongXunMaterialCompilation.outQuantity12;
							data.rows[i].checkQuantity12	=	data.rows[i].hongXunMaterialCompilation.checkQuantity12;
							data.rows[i].diffQuantity12	=	data.rows[i].hongXunMaterialCompilation.diffQuantity12;
							data.rows[i].remark12		=	data.rows[i].hongXunMaterialCompilation.remark12;
						}					
					} 
					return data;
		...
		function synchronization() {
			$.messager.confirm('Confirm', '是否同步库存?', function(r) {
				if (r) {
					$.ajax({
						type : "post",
						url : '${pageContext.request.contextPath}/materialCompilation.htm/synchronization',
		...
		function saveRow(target){			
			return saveOrDelete(target,'${pageContext.request.contextPath}/materialCompilation.htm/getEntity','${pageContext.request.contextPath}/materialCompilation.htm/saveRow','是否保存？');				
		}
