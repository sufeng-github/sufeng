 		...
 		<div id="tb" style="padding:0 10px;height:auto">	
			<div id="ttdiv" style="width:100%;  height:50px;">
				<div style="margin-top:5px; margin-left:10px; float:left">				
					...
					<input class="easyui-textbox" id="scanQ" data-options="iconCls:'icon-search'" style="width:200px;height:35px;"></input> 
		...
		$(function(){
			$('#tt').datagrid({
				...
				columns:[[
					...
					{field:'materialSpecification',title:'型号/规格',align:'center',width:50},		
					/* {field:'materialPlanQuantity',title:'采购数量',align:'center',width:20}, */
					//{field:'materialRealQuantity',title:'库存量',align:'center',width:30},
					{field:'realQuantity',title:'入库数量',align:'center',width:40,editor:'numberbox'}, 
					{field:'materialUnit',title:'单位',align:'center',width:20},  
/* 					{field:'materialPrice',title:'单价',align:'center',width:20},  
					{field:'materialMoney',title:'金额',align:'center',width:20},  
					{field:'materialsupplier',title:'供应商',align:'center',width:60},*/ 
 					//{field:'instoreLocation',title:'库位代码',align:'center',width:40},  	
					{field:'instoreDate',title:'时间日期',width:40,align:'center',sortable: true },   					
					{field:'lotNum',title:'批号',align:'center',width:30,editor:'text'},		
					{field:'remark',title:'备注',align:'center',width:20,editor:'text'},
					//{field:'describtion',title:'描述',align:'center',width:20,editor:'text'},
					...
					{field:'purchaseItemID',title:'purchaseItemID',width:20,hidden:'true'}
					//{field:'parentID',title:'parentID',width:20,hidden:'true'},
					//{field:'uncleID',title:'uncleID',width:20,hidden:'true'}
...
/* 			$("#dialog").dialog({
	...
	<script>
        $(function(){				
			...
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/purchaseItemInStock.htm/getPurchaseItemsInStock',
	...
	<script>
  	...
  	<script>
		...
		function saveRow(target){
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/purchaseItemInStock.htm/getEntity',
				traditional: true,
				dataType:"json", 
				//contentType : 'application/json;charset=utf-8', //设置请求头信息  
				success: function(result) {		
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/purchaseItemInStock.htm/updateRow',
