...
/* 			$("#dialog").dialog({
	...
	<script>
        $(function(){
			...
			$.ajax({ 
				type: "post",  				
				url:'${pageContext.request.contextPath}/onlineStock.htm/loadData',
				traditional: true,
				dataType:"json",  
				beforeSend: function () {
					load();
        ...
        $('#userId').combobox({
				...
				url:'${pageContext.request.contextPath}/onlineStock.htm/autotimp', 	//请求数据路径
				editable:true, 		//可编辑
		        ...
		        onSelect: function(record){
		        	...
		        	$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/onlineStock.htm/searchMaterialNum',
						data:record, 
						traditional: true,
						dataType:"json", 
						beforeSend: function () {
...
/*        	
	...
	<script>
				...
				if (r){
					...
					$('#tt').datagrid('selectRow',rowIndex);
	       			...
	       			if(row.idc!=0){
						...
						$.ajax({  
							type: "post",  
							url: '${pageContext.request.contextPath}/onlineStock.htm/deleteRow',
		...
		function saveRow(target){
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/onlineStock.htm/getEntity',
				traditional: true,
				dataType:"json", 
				//contentType : 'application/json;charset=utf-8', //设置请求头信息  
				success: function(result) {		
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/onlineStock.htm/saveRow',
						data:JSON.stringify(userList), 
						//traditional: true,
						dataType:"json", 
						contentType : 'application/json;charset=utf-8', //设置请求头信息  
		...
		var do_file = (function() {
			return function do_file(files) {
				...
				reader.onload = function(e) {
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/onlineStock.htm/delAllRows',
