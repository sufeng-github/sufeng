...
<body>
		...
		$(function(){
			$('#tt').datagrid({
				...
				columns:[[
					...
					{field:'quantity',title:'出库数量',align:'center',width:40},		 
	...
	<script>
        $(function(){				    
       		$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/weldItemInStock.htm/getWeldItemInStock',
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/weldItemInStock.htm/instoreProductionWeld',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
		  	...
		  	inputEvents: $.extend({}, $.fn.textbox.defaults.inputEvents,{
		    	keyup:function(event){
		         	if(event.keyCode == 13){
		            	...
		            	$.ajax({  
							type: "post",  
							url: '${pageContext.request.contextPath}/weldItemOutStock.htm/outstoreProductionWeld',			
							data:data, 
							traditional: true,
							dataType:"json", 
							beforeSend: function () {
		...
		$('#userId').combobox({
			...
			url : '${pageContext.request.contextPath}/weldItemInStock.htm/autotimp', //请求数据路径				
			editable : true, //可编辑
