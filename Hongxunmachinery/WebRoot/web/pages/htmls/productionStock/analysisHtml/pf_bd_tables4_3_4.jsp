...
<body>
	...
	<script>
        $(function(){				    
       		$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/weldNoLimitItemOutStock.htm/loadData',
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/weldNoLimitItemOutStock.htm/outstoreProduction',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
	...
	<script>
		...
		function saveRow(target){
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/weldNoLimitItemOutStock.htm/getEntity',
				traditional: true,
				dataType:"json", 
				//contentType : 'application/json;charset=utf-8', //设置请求头信息  
				success: function(result) {		
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/weldNoLimitItemOutStock.htm/updateRow',
