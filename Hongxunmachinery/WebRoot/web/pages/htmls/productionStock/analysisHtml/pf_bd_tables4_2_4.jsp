...
<body>
	...
	<script>
        $(function(){				    
       		$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/loadData',
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/outstoreProduction',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
		...
		$('#userId').combobox({
			...
			url : '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/autotimp', //请求数据路径				
			editable : true, //可编辑
                        ...
                        pager.pagination({
                            ...
                            buttons: [{												
									...
									handler:function(){	   
										$.ajax({  
											type: "post",  
											url: '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/getproductionItemInStock',
											//data:{orderNumID:window.parent.window.getOrderNumID()},
											traditional: true,
											dataType:"json", 
											//contentType : 'application/json;charset=utf-8', //设置请求头信息  
	...
	<script>
		...
		function saveRow(target){
			$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/getEntity',
				traditional: true,
				dataType:"json", 
				//contentType : 'application/json;charset=utf-8', //设置请求头信息  
				success: function(result) {		
					...
					$.ajax({  
						type: "post",  
						url: '${pageContext.request.contextPath}/productionNoLimitItemOutStock.htm/updateRow',
