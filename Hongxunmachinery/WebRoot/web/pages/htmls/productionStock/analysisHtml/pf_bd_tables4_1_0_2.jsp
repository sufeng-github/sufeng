...
<body>
	...
	<script>
        $(function(){				    
       		$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/productionItemOutStock.htm/getproductionItemOutStock',
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionItemOutStock.htm/outstoreProduction',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
		...
		$('#userId').combobox({
			...
			url : '${pageContext.request.contextPath}/productionItemOutStock.htm/autotimp', //请求数据路径				
			editable : true, //可编辑
