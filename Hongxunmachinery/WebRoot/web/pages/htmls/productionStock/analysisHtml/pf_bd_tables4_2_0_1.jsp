...
<body>
		...
		$(function(){
			$('#tt').datagrid({
				...
				columns:[[
					...
					{field:'quantity',title:'入库数量',align:'center',width:40},		 
	...
	<script>
        $(function(){				    
       		$.ajax({  
				type: "post",  
				url: '${pageContext.request.contextPath}/productionItemInStock.htm/getproductionItemInStock',
		...
		function inputEnter() {
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionItemInStock.htm/instoreProduction',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
