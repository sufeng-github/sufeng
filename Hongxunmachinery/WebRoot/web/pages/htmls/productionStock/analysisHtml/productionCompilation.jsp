			...
			$('#tt').datagrid({	
				loadFilter: function(data){									
 					for(var i=0; i<data.rows.length;i++){
						if(data.rows[i].hongXunAssembleCompilation != null){
							data.rows[i].quantity1		=	data.rows[i].hongXunAssembleCompilation.quantity1;
							data.rows[i].inQuantity1	=	data.rows[i].hongXunAssembleCompilation.inQuantity1;
							data.rows[i].outQuantity1	=	data.rows[i].hongXunAssembleCompilation.outQuantity1;
							data.rows[i].checkQuantity1	=	data.rows[i].hongXunAssembleCompilation.checkQuantity1;
							data.rows[i].diffQuantity1	=	data.rows[i].hongXunAssembleCompilation.diffQuantity1;
							data.rows[i].remark1		=	data.rows[i].hongXunAssembleCompilation.remark1;
							data.rows[i].quantity2		=	data.rows[i].hongXunAssembleCompilation.quantity2;
							data.rows[i].inQuantity2	=	data.rows[i].hongXunAssembleCompilation.inQuantity2;
							data.rows[i].outQuantity2	=	data.rows[i].hongXunAssembleCompilation.outQuantity2;
							data.rows[i].checkQuantity2	=	data.rows[i].hongXunAssembleCompilation.checkQuantity2;
							data.rows[i].diffQuantity2	=	data.rows[i].hongXunAssembleCompilation.diffQuantity2;
							data.rows[i].remark2		=	data.rows[i].hongXunAssembleCompilation.remark2;
							data.rows[i].quantity3		=	data.rows[i].hongXunAssembleCompilation.quantity3;
							data.rows[i].inQuantity3	=	data.rows[i].hongXunAssembleCompilation.inQuantity3;
							data.rows[i].outQuantity3	=	data.rows[i].hongXunAssembleCompilation.outQuantity3;
							data.rows[i].checkQuantity3	=	data.rows[i].hongXunAssembleCompilation.checkQuantity3;
							data.rows[i].diffQuantity3	=	data.rows[i].hongXunAssembleCompilation.diffQuantity3;
							data.rows[i].remark3		=	data.rows[i].hongXunAssembleCompilation.remark3;
							data.rows[i].quantity4		=	data.rows[i].hongXunAssembleCompilation.quantity4;
							data.rows[i].inQuantity4	=	data.rows[i].hongXunAssembleCompilation.inQuantity4;
							data.rows[i].outQuantity4	=	data.rows[i].hongXunAssembleCompilation.outQuantity4;
							data.rows[i].checkQuantity4	=	data.rows[i].hongXunAssembleCompilation.checkQuantity4;
							data.rows[i].diffQuantity4	=	data.rows[i].hongXunAssembleCompilation.diffQuantity4;
							data.rows[i].remark4		=	data.rows[i].hongXunAssembleCompilation.remark4;
							data.rows[i].quantity5		=	data.rows[i].hongXunAssembleCompilation.quantity5;
							data.rows[i].inQuantity5	=	data.rows[i].hongXunAssembleCompilation.inQuantity5;
							data.rows[i].outQuantity5	=	data.rows[i].hongXunAssembleCompilation.outQuantity5;
							data.rows[i].checkQuantity5	=	data.rows[i].hongXunAssembleCompilation.checkQuantity5;
							data.rows[i].diffQuantity5	=	data.rows[i].hongXunAssembleCompilation.diffQuantity5;
							data.rows[i].remark5		=	data.rows[i].hongXunAssembleCompilation.remark5;
							data.rows[i].quantity6		=	data.rows[i].hongXunAssembleCompilation.quantity6;
							data.rows[i].inQuantity6	=	data.rows[i].hongXunAssembleCompilation.inQuantity6;
							data.rows[i].outQuantity6	=	data.rows[i].hongXunAssembleCompilation.outQuantity6;
							data.rows[i].checkQuantity6	=	data.rows[i].hongXunAssembleCompilation.checkQuantity6;
							data.rows[i].diffQuantity6	=	data.rows[i].hongXunAssembleCompilation.diffQuantity6;
							data.rows[i].remark6		=	data.rows[i].hongXunAssembleCompilation.remark6;
							data.rows[i].quantity7		=	data.rows[i].hongXunAssembleCompilation.quantity7;
							data.rows[i].inQuantity7	=	data.rows[i].hongXunAssembleCompilation.inQuantity7;
							data.rows[i].outQuantity7	=	data.rows[i].hongXunAssembleCompilation.outQuantity7;
							data.rows[i].checkQuantity7	=	data.rows[i].hongXunAssembleCompilation.checkQuantity7;
							data.rows[i].diffQuantity7	=	data.rows[i].hongXunAssembleCompilation.diffQuantity7;
							data.rows[i].remark7		=	data.rows[i].hongXunAssembleCompilation.remark7;
							data.rows[i].quantity8		=	data.rows[i].hongXunAssembleCompilation.quantity8;
							data.rows[i].inQuantity8	=	data.rows[i].hongXunAssembleCompilation.inQuantity8;
							data.rows[i].outQuantity8	=	data.rows[i].hongXunAssembleCompilation.outQuantity8;
							data.rows[i].checkQuantity8	=	data.rows[i].hongXunAssembleCompilation.checkQuantity8;
							data.rows[i].diffQuantity8	=	data.rows[i].hongXunAssembleCompilation.diffQuantity8;
							data.rows[i].remark8		=	data.rows[i].hongXunAssembleCompilation.remark8;
							data.rows[i].quantity9		=	data.rows[i].hongXunAssembleCompilation.quantity9;
							data.rows[i].inQuantity9	=	data.rows[i].hongXunAssembleCompilation.inQuantity9;
							data.rows[i].outQuantity9	=	data.rows[i].hongXunAssembleCompilation.outQuantity9;
							data.rows[i].checkQuantity9	=	data.rows[i].hongXunAssembleCompilation.checkQuantity9;
							data.rows[i].diffQuantity9	=	data.rows[i].hongXunAssembleCompilation.diffQuantity9;
							data.rows[i].remark9		=	data.rows[i].hongXunAssembleCompilation.remark9;
							data.rows[i].quantity10		=	data.rows[i].hongXunAssembleCompilation.quantity10;
							data.rows[i].inQuantity10	=	data.rows[i].hongXunAssembleCompilation.inQuantity10;
							data.rows[i].outQuantity10	=	data.rows[i].hongXunAssembleCompilation.outQuantity10;
							data.rows[i].checkQuantity10	=	data.rows[i].hongXunAssembleCompilation.checkQuantity10;
							data.rows[i].diffQuantity10	=	data.rows[i].hongXunAssembleCompilation.diffQuantity10;
							data.rows[i].remark10		=	data.rows[i].hongXunAssembleCompilation.remark10;
							data.rows[i].quantity11		=	data.rows[i].hongXunAssembleCompilation.quantity11;
							data.rows[i].inQuantity11	=	data.rows[i].hongXunAssembleCompilation.inQuantity11;
							data.rows[i].outQuantity11	=	data.rows[i].hongXunAssembleCompilation.outQuantity11;
							data.rows[i].checkQuantity11	=	data.rows[i].hongXunAssembleCompilation.checkQuantity11;
							data.rows[i].diffQuantity11	=	data.rows[i].hongXunAssembleCompilation.diffQuantity11;
							data.rows[i].remark11		=	data.rows[i].hongXunAssembleCompilation.remark11;
							data.rows[i].quantity12		=	data.rows[i].hongXunAssembleCompilation.quantity12;
							data.rows[i].inQuantity12	=	data.rows[i].hongXunAssembleCompilation.inQuantity12;
							data.rows[i].outQuantity12	=	data.rows[i].hongXunAssembleCompilation.outQuantity12;
							data.rows[i].checkQuantity12	=	data.rows[i].hongXunAssembleCompilation.checkQuantity12;
							data.rows[i].diffQuantity12	=	data.rows[i].hongXunAssembleCompilation.diffQuantity12;
							data.rows[i].remark12		=	data.rows[i].hongXunAssembleCompilation.remark12;
						}					
					} 
					return data;					
				},
...
/* 			var str = localStorage.getItem('authority2'); 			
		...
		function saveRow(target){			
			return saveOrDelete(target,'${pageContext.request.contextPath}/assembleCompilation.htm/getEntity','${pageContext.request.contextPath}/assembleCompilation.htm/saveRow','是否保存？');				
		}
