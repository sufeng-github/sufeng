...
<body>  
			...
			$('#tt').datagrid({
				...
				columns:[[
 					...
 					{field:'action1',title:'OP',width:40,align:'center',
  					...
  					{field:'pon',title:'pon',width:100,align:'center'},
					{field:'quantity',title:'订单数量',width:100,align:'center'},
					{field:'poCreateDate',title:'订单创建日期',width:100,align:'center'},
					{field:'totalAmount',title:'金额',width:100,align:'center',
						formatter:function(value,row,index){ 
							if(value == undefined){
								return '';
							}else{	
					...
					{field:'supplier',title:'供应商',width:100,align:'center',editor:'text'},
	...
	<script>	
        ...
        $(function(){				
        	...
        	$.ajax({ 
				type: "post",  				
				url:'${pageContext.request.contextPath}/ponNum.htm/loadData',
				traditional: true,
				dataType:"json",  
				beforeSend: function () {
					load();
        ...
        function spreadrow(target){
	        ...
	        $("#dialog").dialog({
			     ...
			     queryParams: {pon:row.pon},
			     content:"<iframe scrolling='auto' frameborder='0' src='./pf_bd_tables4_1_0.html' style='width:100%; height:100%; display:block;'></iframe>"
			});
	...
	<script>
	 	function getDlgPon(dialog){
			var obj=$(dialog).dialog('options');
			var queryParams = obj["queryParams"];            
			return queryParams["pon"];
		} 
