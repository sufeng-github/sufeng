...
<link rel="stylesheet" type="text/css"
	href="../../../../custom/uimaker/icon.css">
<script type="text/javascript" src="../../../../custom/jquery.min.js"></script>
<script type="text/javascript"
	src="../../../../custom/jquery.easyui.min.js"></script>
...
<script type="text/javascript"
	src="../../../../custom/easyui-lang-zh_CN.js"></script>
...
<body>
		...
		<div id="tb" style="padding:0 10px;height:auto">
			<div id="ttdiv" style="width:100%;  height:50px;">
				<div style="margin-top:5px; margin-left:10px; float:left">
					<input type="text" id="quantityId" class="easyui-numberbox"
						value="" data-options="min:1,prompt:'入库数量'"
						style="width:90px;height:35px;"> <input
						class="easyui-textbox" id="scanQ"
						data-options="iconCls:'icon-search'"
						style="width:200px;height:35px;"> <input
						class="easyui-combobox" id="userId"
						style="width:400px;height:35px;"></input> <a href="javascript:;"
						class="easyui-linkbutton"
						onclick="$('#tt').datagrid('toExcel','dg.xls')">导出</a> <a
						href="javascript:;" class="easyui-linkbutton"
						onclick="$('#tt').datagrid('print','DataGrid')">打印</a> <input
						id="sbutton" class="easyui-switchbutton" checked onText="手动"
						offText="扫描" style="width:100px;height:35px">
				</div>
			</div>
		</div>
		<table id="tt"></table>
	...
	<script>
		$(function() {
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionNoLimitItemInStock.htm/loadData',
		...
		function inputEnter() {
			...
			//data["id"] = window.parent.window.getOrderNumID();
			...
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionNoLimitItemInStock.htm/instoreProduction',
				data : data,
				traditional : true,
				dataType : "json",
				beforeSend : function() {
				...
				keyup : function(event) {
					if (event.keyCode == 13) {
						...
						if (qvalue.indexOf("#") > -1) {															
							...
							//data["worknum"] = qvalue.split("#")[2];
							//alert(qvalue.split("#").length);
		...
		$('#userId').combobox({
			...
			url : '${pageContext.request.contextPath}/productionNoLimitItemInStock.htm/autotimp', //请求数据路径				
			editable : true, //可编辑
	...
	<script>
		...
		function saveRow(target) {
			$.ajax({
				type : "post",
				url : '${pageContext.request.contextPath}/productionNoLimitItemInStock.htm/getEntity',
				traditional : true,
				dataType : "json",
				//contentType : 'application/json;charset=utf-8', //设置请求头信息  
				success : function(result) {
					...
					$.ajax({
						type : "post",
						url : '${pageContext.request.contextPath}/productionNoLimitItemInStock.htm/updateRow',
