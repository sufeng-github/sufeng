...
public class HongXunDeliveryWeldItem implements java.io.Serializable,Cloneable{
		...
		@Override  
	    public HongXunDeliveryWeldItem clone() {  
			HongXunDeliveryWeldItem hongXunBomTree = null;  
	        try{  
	        	hongXunBomTree = (HongXunDeliveryWeldItem)super.clone();  
