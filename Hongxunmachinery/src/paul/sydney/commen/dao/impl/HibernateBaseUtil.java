package paul.sydney.commen.dao.impl;
...
public class HibernateBaseUtil<T, ID extends Serializable> extends CustomHibernateDaoSupport implements IHibernateBaseUtil<T, ID> {
     ...
     * <保存所有>
     * @param entities 实体的Collection集合
     * @see com.chat.common.dao.IHibernateBaseUtil#saveAll(java.util.Collection)
     */
    @Override
     ...
     * <保存所有>
     * @param entities 实体的Collection集合
     * @see com.chat.common.dao.IHibernateBaseUtil#saveOrUpdateAll(java.util.Collection)
     */
	@Override
	public void saveOrUpdateAll(Collection<T> entities) {
		// TODO Auto-generated method stub
		for(Iterator<T> it = entities.iterator();it.hasNext(); saveOrUpdate(it.next()));
	}
    /**
     * <更新所有>
     * @param entities 实体的Collection集合
	...
	public void updateEntityAll(Collection<T> entities) {
		// TODO Auto-generated method stub
		for(Iterator<T> it = entities.iterator();it.hasNext(); updateEntity(it.next()));
	}
