...
public class ServiceOnlineStockImpl implements ServiceOnlineStockInf{
	...
	public List<Map<String, Object>> loadData() {
		...
		List<HongXunOnlineStock>  hongXunOnlineStocks = iOnlineStockDao.quary(new HongXunOnlineStock());
...
/*		map.put("unit", item.getUnit());
	...
	public List<Map<String, Object>> saveRow(HongXunOnlineStock hongXunOnlineStock) {
		// TODO Auto-generated method stub
		iOnlineStockDao.save(hongXunOnlineStock);
		Map<String,Object> map = new HashMap<String,Object>();
	...
	public List<Map<String, Object>> delAllRows() {
		// TODO Auto-generated method stub
		List<HongXunOnlineStock>  hongXunOnlineStocks = iOnlineStockDao.quary(new HongXunOnlineStock());
		iOnlineStockDao.deleteOnlineItemList(hongXunOnlineStocks);
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
		return list;
	}
