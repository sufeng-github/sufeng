	...
	public List<Map<String, Object>> searchMaterialNum(String materialNum, int quantity) {
    	...
    	if(hongXunMaterialStock != null){
    		...
    		if(hongXunMaterialItemOutStock != null){
    			...
    			iMaterialNoLimitOutStockDao.saveEntity(hongXunMaterialItemOutStock);	
    	    	Map<String, Object> map = new HashMap<String, Object>();
...
/*		Map<String, Object> map = new HashMap<String, Object>();
	...
	public Collection<? extends Map<String, Object>> updateRow(HongXunMaterialNoLimitOutStock item) {
		// TODO Auto-generated method stub
		HongXunMaterialStock hongXunMaterialStock = iMaterialStockDao.get(item.getMaterialStockID());
		HongXunMaterialNoLimitOutStock hongXunMaterialNoLimitOutStock = iMaterialNoLimitOutStockDao.get(item.getIdc());	
		...
		if(min<30){			
			...
			iMaterialStockDao.updateEntity(hongXunMaterialStock);
			iMaterialNoLimitOutStockDao.updateEntity(hongXunMaterialNoLimitOutStock);
			mapHongXunMaterialItemOutStock(map, item);
			list.add(map);
			return list;
		}else{
