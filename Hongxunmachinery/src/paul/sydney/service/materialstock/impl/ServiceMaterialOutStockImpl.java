...
/*			    	    		boolean flag = false;
    	...
    	if(hongXunMaterialStock != null && hongXunMaterialItemOutStock != null && hongXunMaterialOutStoreItem != null ){
    		...
    		iMaterialItemOutStockDao.saveEntity(hongXunMaterialItemOutStock);
	...
	public Collection<? extends Map<String, Object>> updateRow(HongXunMaterialItemOutStock item) {
		// TODO Auto-generated method stub
		HongXunMaterialOutStoreItem hongXunMaterialOutStoreItem = iMaterialOutStockItemDao.get(item.getOutStoreItemID());		
		...
		Map<String, Object> map = new HashMap<String, Object>();
		if(hongXunMaterialStock != null){
			HongXunMaterialItemOutStock hongXunMaterialItemOutStock = iMaterialItemOutStockDao.get(item.getIdc());	
			...
			if(min<30){	
				...
				iMaterialItemOutStockDao.updateEntity(hongXunMaterialItemOutStock);
				mapHongXunMaterialItemOutStock(map, item);
				list.add(map);
				return list;
			}else{
