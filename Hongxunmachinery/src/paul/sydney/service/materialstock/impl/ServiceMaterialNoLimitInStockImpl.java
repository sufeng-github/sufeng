...
*/		List<HongXunMaterialStock> hongXunMaterialStocks = iMaterialStockDao.quary(hongXunMaterialStock);//(List<HongXunMaterialStock>) stockDao.quarywithpara("HongXunMaterialStock", "materialNum", materialNum); 
    	...
    	if(hongXunMaterialStock != null && hongXunMaterialNoLimitInStock != null){
    		...
    		iMaterialNoLimitInStockDao.save(hongXunMaterialNoLimitInStock);
    		Map<String, Object> map = new HashMap<String, Object>();
...
/*		Map<String, Object> map = new HashMap<String, Object>();
	...
	public Collection<? extends Map<String, Object>> updateRow(HongXunMaterialNoLimitInStock item) {
		// TODO Auto-generated method stub
		HongXunMaterialStock hongXunMaterialStock = iMaterialStockDao.hongXunMaterialFindById(item.getMaterialStockID());
		HongXunMaterialNoLimitInStock hongXunMaterialNoLimitInStock = iMaterialNoLimitInStockDao.materialNoLimitInStockFindById(item.getIdc());	
		...
		if(min<30){	
			...
			iMaterialStockDao.update(hongXunMaterialStock);
			iMaterialNoLimitInStockDao.update(hongXunMaterialNoLimitInStock);
			mapHongXunMaterialItemInStock(map, item);
			list.add(map);
			return list;
		}else{
