...
public class ServiceDeliveryWeldNumImpl implements ServiceDeliveryWeldNumInf{
	...
	@Autowired
	IWeldDeliveryNumDao iWeldDeliveryNumDao;
	public void setStockDao(IWeldDeliveryNumDao iWeldDeliveryNumDao) {
		this.iWeldDeliveryNumDao = iWeldDeliveryNumDao;
	}
	@Autowired
	IWeldDeliveryItemDao iWeldDeliveryItemDao;
	public void setStockDao(IWeldDeliveryItemDao iWeldDeliveryItemDao) {
		this.iWeldDeliveryItemDao = iWeldDeliveryItemDao;
	}
	...
	public List<Map<String, Object>> loadData() {
		...
		List<HongXunDeliveryWeldNum>  hongXunDeliveryNums = iWeldDeliveryNumDao.quary(new HongXunDeliveryWeldNum());
	...
	public List<Map<String, Object>> autotimp(String str) {
		...
		List<HongXunDeliveryWeldNum> hongXunDeliveryNums = iWeldDeliveryNumDao.quary(hongXunDeliveryWeldNum);
	...
	public List<Map<String, Object>> saveRow(HongXunDeliveryWeldNum hongXunDeliveryWeldNum) {
		// TODO Auto-generated method stub
		iWeldDeliveryNumDao.save(hongXunDeliveryWeldNum);
		Map<String,Object> map = new HashMap<String,Object>();
	...
	public List<Map<String, Object>> updateRow(HongXunDeliveryWeldNum hongXunDeliveryWeldNum) {
		// TODO Auto-generated method stub
		iWeldDeliveryNumDao.update(hongXunDeliveryWeldNum);
		Map<String,Object> map = new HashMap<String,Object>();
	...
	public List<Map<String, Object>> changeStatus(int deliveryNumID) {
		...
		List<HongXunDeliveryWeldItem> hongXunDeliveryWeldItems = iWeldDeliveryItemDao.quary(hongXunDeliveryWeldItem);
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
		Map<String,Object> map = new HashMap<String,Object>();
		String status = "完成";
		...
		HongXunDeliveryWeldNum hongXunDeliveryWeldNum = iWeldDeliveryNumDao.deliveryWeldNumFindById(deliveryNumID); 
...
/*	@Override
	public List<Map<String, Object>> lotOutStock(List<HongXunProductionStock> hongXunProductionStockList) {
		// TODO Auto-generated method stub
		List<HongXunProductionStock>  hongXunProductionStocks = iWeldDeliveryNumDao.quary(new HongXunProductionStock());
	...
	public List<Map<String, Object>> deleteRow(int id) {
		// TODO Auto-generated method stub
		HongXunDeliveryWeldNum hongXunDeliveryWeldNum = iWeldDeliveryNumDao.deliveryWeldNumFindById(id);
		HongXunDeliveryWeldItem hongXunDeliveryWeldItem = new HongXunDeliveryWeldItem();
		...
		for(HongXunDeliveryWeldItem item: hongXunDeliveryWeldItems){
			...
			iWeldDeliveryItemDao.delete(item);
		}
		iWeldDeliveryNumDao.delete(hongXunDeliveryWeldNum);
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
		return list;
	}
/*	@Override
