...
public class ServiceWeldNoLimitItemOutStockImpl implements ServiceWeldNoLimitItemOutStockInf{
	...
	@Autowired
	IWeldNoLimitItemOutStockDao iWeldNoLimitItemOutStockDao;
	public void setStockDao(IWeldNoLimitItemOutStockDao iWeldNoLimitItemOutStockDao) {
		this.iWeldNoLimitItemOutStockDao = iWeldNoLimitItemOutStockDao;
	}
	@Override
	public List<Map<String, Object>> loadData() {
		...
		List<HongXunWeldNoLimitItemOutStock> hongXunWeldNoLimitItemOutStocks = iWeldNoLimitItemOutStockDao.quary(new HongXunWeldNoLimitItemOutStock());
	...
	private void savaProductionNoLimitItemOutStock(String materialNum, String specification, Integer quantity, List<Map<String, Object>> list){
		...
		iWeldNoLimitItemOutStockDao.save(hongXunWeldNoLimitItemOutStock);
		Map<String, Object> map = new HashMap<String, Object>();
		mapHongXunWeldNoLimitItemOutStock(map,hongXunWeldNoLimitItemOutStock);
		list.add(map);
	}
	...
	public Collection<? extends Map<String, Object>> updateRow(HongXunWeldNoLimitItemOutStock item) {
		...
		HongXunWeldNoLimitItemOutStock hongXunWeldNoLimitItemOutStock = iWeldNoLimitItemOutStockDao.weldNoLimitItemOutStockFindById(item.getIdc());	
		...
		if(hour<30){	
			...
			if(hongXunProductionWeldStocks==null || hongXunProductionWeldStocks.size() == 0){
				...
				iWeldDao.update(hongXunProductionWeldStocks.get(0));
				iWeldNoLimitItemOutStockDao.update(hongXunWeldNoLimitItemOutStock);
