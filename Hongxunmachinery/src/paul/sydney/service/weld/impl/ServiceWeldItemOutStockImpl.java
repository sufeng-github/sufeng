...
public class ServiceWeldItemOutStockImpl implements ServiceWeldItemOutStockInf{
	...
	@Autowired
	IWeldItemOutStockDao iWeldItemOutStockDao;
	public void setStockDao(IWeldItemOutStockDao iWeldItemOutStockDao) {
		this.iWeldItemOutStockDao = iWeldItemOutStockDao;
	}
	@Autowired
		...
		if(hongXunProductionWeldStocks.size()==0){
    		...
    		if(hongXunProductionWeldStocks.get(0).getQuantity() != null){
    			...
    			if(outQuantity>-1){   
    				...
    				iWeldItemOutStockDao.save(hongXunWeldItemOutStock);
