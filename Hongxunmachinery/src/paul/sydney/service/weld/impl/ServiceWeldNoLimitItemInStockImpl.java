...
public class ServiceWeldNoLimitItemInStockImpl implements ServiceWeldNoLimitItemInStockInf{
	...
	@Autowired
	IWeldNoLimitItemInStockDao iWeldNoLimitItemInStockDao;
	public void setStockDao(IWeldNoLimitItemInStockDao iWeldNoLimitItemInStockDao) {
		this.iWeldNoLimitItemInStockDao = iWeldNoLimitItemInStockDao;
	}
	@Override
	public List<Map<String, Object>> loadData() {
		...
		List<HongXunWeldNoLimitItemInStock> hongXunWeldNoLimitItemInStocks = iWeldNoLimitItemInStockDao.quary(new HongXunWeldNoLimitItemInStock());
	...
	private void savaProductionNoLimitItemInStock(String materialNum, String specification, Integer quantity, List<Map<String, Object>> list){
		...
		iWeldNoLimitItemInStockDao.save(hongXunWeldNoLimitItemInStock);
		Map<String, Object> map = new HashMap<String, Object>();
		mapHongXunWeldNoLimitItemInStock(map,hongXunWeldNoLimitItemInStock);
		list.add(map);
	}
	...
	public Collection<? extends Map<String, Object>> updateRow(HongXunWeldNoLimitItemInStock item) {
		...
		HongXunWeldNoLimitItemInStock hongXunWeldNoLimitItemInStock = iWeldNoLimitItemInStockDao.weldNoLimitItemInStockFindById(item.getIdc());	
		...
		if(hour<30){	
			...
			if(hongXunProductionWeldStocks==null || hongXunProductionWeldStocks.size() == 0){
				...
				iWeldDao.update(hongXunProductionWeldStocks.get(0));
				iWeldNoLimitItemInStockDao.update(hongXunWeldNoLimitItemInStock);
