...
public interface ServiceWeldItemOutStockInf {
	...
	List<Map<String, Object>> outstoreProductionWeld(String materialNum, int purchaseNumID, int quantity);
	List<Map<String, Object>> getWeldItemsOutStore(int purchaseNumID);
