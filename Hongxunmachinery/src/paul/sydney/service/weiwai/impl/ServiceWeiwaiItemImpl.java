...
public class ServiceWeiwaiItemImpl implements ServiceWeiwaiItemInf{
	...
	@Autowired
	IWeiwaiNumDao iWeiwaiDao;
	public void setStockDao(IWeiwaiNumDao iWeiwaiDao) {
	...
	public List<Map<String, Object>> loadData() {
		...
		List<HongXunWeiwaiItem> hongXunWeiwaiItems = iWeiwaiItemDao.quary(hongXunWeiwaiItem);
	...
	public List<Map<String, Object>> saveRow(HongXunWeiwaiItem hongXunDataFive) {
		...
		iWeiwaiItemDao.save(hongXunDataFive);
		Map<String,Object> map = new HashMap<String,Object>();
	...
	public List<Map<String, Object>> deleteRow(int ID) {
		// TODO Auto-generated method stub
		HongXunWeiwaiItem hongXunDataFive = iWeiwaiItemDao.dataFiveFindById(ID);
		iWeiwaiItemDao.deletRow(hongXunDataFive);
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
		return list;
	}
	...
	public List<Map<String, Object>> updateRow(HongXunWeiwaiItem hongXunDataFive) {
		...
		iWeiwaiItemDao.update(hongXunDataFive);
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("weiwaiMoney", hongXunDataFive.getWeiwaiMoney());
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
		list.add(map);
